...
CONNECTED_LAYER_SIZE2 = 256
CONNECTED_LAYER_SIZE3 = 64
...
def main():
    ...
    colorPool1 = tf.layers.max_pooling2d(inputs=colorLayerConv1, pool_size=[2, 2], strides=2)
    ...
    colorPool2 = tf.layers.max_pooling2d(inputs=colorLayerConv2, pool_size=[2, 2], strides=2)
    ...
    colorFlat1, _ = flattenLayer(colorLayerConv3)

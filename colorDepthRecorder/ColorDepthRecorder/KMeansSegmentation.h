...
inline cv::Mat getKmeansSegmentationMask(cv::Mat * sourceImage, const int numOfClusters, const int maxIter, const int maxError, const int numOfAttempts)
{
...
inline cv::Mat getKmeansSegmentation(cv::Mat * sourceImage, const int numOfClusters, const int maxIter, const int maxError, const int numOfAttempts)
{
	cv::Mat src = sourceImage->clone();
...
inline cv::Mat getKmeansSegmentationHSV(cv::Mat * sourceImage, const int numOfClusters, const int maxIter, const int maxError, const int numOfAttempts)
{

...
public:
	...
	cv::Mat getEqedDepth() { return depthFrameEqed_; }
	cv::Mat getEqedeDepth8() { return depthFrame8Eqed_; }
private:
	...
	cv::Mat depthFrame_;
	cv::Mat depthFrameEqed_;
	cv::Mat depthFrame8_;
	cv::Mat depthFrame8Eqed_;
	...
	uint16_t * temporaryDepthValues_;
